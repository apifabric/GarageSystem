...
try:
    ...
    session.commit()
    garage1 = Garage(name="City Center Garage", location="Downtown", capacity=100)
    garage2 = Garage(name="Suburban Auto", location="Suburb", capacity=50)
    garage3 = Garage(name="Rural Roadside", location="Countryside", capacity=30)
    garage4 = Garage(name="Highway Hub", location="Highway", capacity=200)
    car1 = Car(model="Model S", make="Tesla", year=2020, registration_number="123ABC", owner_id=1)
    car2 = Car(model="Accord", make="Honda", year=2018, registration_number="456DEF", owner_id=2)
    car3 = Car(model="F-150", make="Ford", year=2021, registration_number="789GHI", owner_id=1)
    car4 = Car(model="Corolla", make="Toyota", year=2019, registration_number="012JKL", owner_id=3)
    owner1 = Owner(name="Alice Johnson", address="123 Elm St", contact_number="555-0123")
    owner2 = Owner(name="Bob Smith", address="456 Maple Dr", contact_number="555-4567")
    owner3 = Owner(name="Carol King", address="789 Oak Ave", contact_number="555-7890")
    owner4 = Owner(name="Dave Lee", address="321 Pine Rd", contact_number="555-3210")
    service1 = Service(car_id=1, service_date=date(2023, 7, 25), description="Oil change")
    service2 = Service(car_id=2, service_date=date(2023, 6, 14), description="Tire rotation")
    service3 = Service(car_id=3, service_date=date(2023, 8, 10), description="Brake inspection")
    service4 = Service(car_id=4, service_date=date(2023, 5, 5), description="Battery replacement")
    ...
    repair1 = Repair(service_id=1, part_id=2, repair_date=date(2023, 7, 26))
    repair2 = Repair(service_id=2, part_id=1, repair_date=date(2023, 6, 15))
    repair3 = Repair(service_id=3, part_id=3, repair_date=date(2023, 8, 11))
    repair4 = Repair(service_id=4, part_id=4, repair_date=date(2023, 5, 6))
    ...
    invoice1 = Invoice(service_id=1, total_amount=150)
    invoice2 = Invoice(service_id=2, total_amount=200)
    invoice3 = Invoice(service_id=3, total_amount=180)
    invoice4 = Invoice(service_id=4, total_amount=250)
