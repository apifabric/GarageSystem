...
resourcename="garagesystem"  # lower case, only
resourcegroup="garagesystem_rg"
...
# git clone https://github.com/apilogicserver/garagesystem.git
# cd garagesystem
...
az group create --name garagesystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group garagesystem_rg --sku S1 --is-linux
az container create --resource-group garagesystem_rg --name garagesystem --image apilogicserver/garagesystem:latest --dns-name-label garagesystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//garagesystem.westus.azurecontainer.io:5656'
